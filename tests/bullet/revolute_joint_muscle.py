...
def main():
    ...
    params = container.muscles.parameters
    lmtu1 = params.get_parameter('lmtu_m1')
    lmtu2 = params.get_parameter('lmtu_m2')
    stim1 = u.get_parameter('stim_m1')
    stim2 = u.get_parameter('stim_m2')
    force1 = container.muscles.forces.get_parameter('tendon_force_m1')
    force2 = container.muscles.forces.get_parameter('tendon_force_m2')
    N = 10000
