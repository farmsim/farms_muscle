...
class Parameters(object):
    """Parent class providing main attributes for muscle system
    """

    def __init__(self, sys_name='main'):
...
class MuscleParameters(Parameters):
    """ Muscle parameters
    ...
    def __init__(self, **kwargs):
        ...
        self.parameters['m_id'] = kwargs.get('m_id', str(uuid.uuid4()))
...
class MuscleJointParameters(Parameters):
...
class JointParameters(Parameters):
